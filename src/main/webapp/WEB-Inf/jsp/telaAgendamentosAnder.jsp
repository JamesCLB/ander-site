...
<div class="conteudo-principal-agendamentos">
	...
	<div class="menu-filtros">
		...
		<select name="nome-barbeiro" id="barber-name" class="filtro filtroNome select-custom" onchange="redirecionarParaAgendamentos()">
		...
		<form action="/listarAgendamentosNomeCliente" method="get" >
			<input name="nomeCliente" type="text" value="Nome cliente" id="btn-nomeCLiente" class="filtro select-custom">
